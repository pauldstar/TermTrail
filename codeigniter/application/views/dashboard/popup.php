...
<div class="div-revision-popup">
	<div class="div-revision-tutorial-alert left">
		<img class="img-tutorial-arrow left" src="<?=base_url('images/direction-tab-left.png')?>">
	...
	<div class="div-revision-main-content fail">
		<div class="div-revision-toolbar w-hidden-tiny">
			<div class="div-tool-dropdown-wrapper w-dropdown" data-delay="0" id="options-bar-sort">
				<div class="div-tool-dropdown-toggle w-dropdown-toggle" id="options-bar-pause-revision"><img src="<?=base_url('images/pause.png')?>"></div>
				<nav class="div-tool-dropdown-list w-dropdown-list"></nav>
			</div>
			<div class="div-tool-dropdown-wrapper w-dropdown" data-delay="0" id="options-bar-sort">
				<div class="div-tool-dropdown-toggle w-dropdown-toggle" id="options-bar-stop-revision"><img src="<?=base_url('images/stop.png')?>"></div>
				<nav class="div-tool-dropdown-list w-dropdown-list"></nav>
			</div>
			<div class="div-tool-dropdown-wrapper w-dropdown" data-delay="0" data-hover="1" id="options-bar-search">
				<div class="div-tool-dropdown-toggle w-dropdown-toggle" id="options-bar-archive"><img src="<?=base_url('images/archive.png')?>"></div>
				<nav class="div-tool-dropdown-list w-dropdown-list"></nav>
			</div>
			<div class="div-tool-dropdown-wrapper w-dropdown" data-delay="0" data-hover="1" id="options-bar-sort">
				<div class="div-tool-dropdown-toggle w-dropdown-toggle" id="options-bar-delete"><img src="<?=base_url('images/delete_1.png')?>"></div>
				<nav class="div-tool-dropdown-list w-dropdown-list"></nav>
			</div>
			<div class="div-tool-dropdown-wrapper w-dropdown" data-delay="0" data-hover="1" id="options-bar-sort">
				<div class="div-tool-dropdown-toggle inactive w-dropdown-toggle" id="options-bar-edit"><img src="<?=base_url('images/edit.png')?>"></div>
				<nav class="div-tool-dropdown-list w-dropdown-list"></nav>
			</div>
			<div class="div-tool-dropdown-wrapper w-dropdown" data-delay="0" data-hover="1" id="options-bar-randomise">
				<div class="div-tool-dropdown-toggle enabled w-dropdown-toggle" id="options-bar-edit"><img src="<?=base_url('images/dice.png')?>"></div>
				<nav class="div-tool-dropdown-list w-dropdown-list"></nav>
			</div>
			<div class="div-tool-dropdown-wrapper w-dropdown" data-delay="0" data-hover="1" id="options-bar-sort">
				<div class="div-tool-dropdown-toggle w-dropdown-toggle" id="options-bar-settings"><img src="<?=base_url('images/settings.png')?>"></div>
				<nav class="div-tool-dropdown-list w-dropdown-list"></nav>
			</div>
			<div class="div-tool-dropdown-wrapper w-dropdown" data-delay="0" data-hover="1" id="options-bar-sort">
				<div class="div-tool-dropdown-toggle w-dropdown-toggle" id="options-bar-shortcuts"><img src="<?=base_url('images/shortcut-arrow.png')?>"></div>
				<nav class="div-tool-dropdown-list w-dropdown-list"></nav>
			</div>
			<div class="div-tool-dropdown-wrapper w-dropdown" data-delay="0" data-hover="1" data-ix="tutorial-disable" id="options-bar-sort">
				<div class="div-tool-dropdown-toggle enabled w-dropdown-toggle" id="options-bar-info"><img src="<?=base_url('images/exclamation.png')?>"></div>
				<nav class="div-tool-dropdown-list w-dropdown-list"></nav>
			</div>
		</div>
		<div class="div-revision-main-header">
			<h4 class="h-number-revision" id="number-revision-question">10.10</h4>
		...
		<div class="btn div-revision-text-section">
			...
			<div class="div-question-section-text"><img class="img-toggle-revision-question-text" src="<?=base_url('images/up-arrow.png')?>"></div>
		</div>
		<div class="answer div-revision-text-section">
			...
			<div class="div-question-section-text">
				...
				<img src="<?=base_url('images/math-trig-diagram-DHD.gif')?>">
			</div>
		</div>
		<div class="div-revision-main-footer">
			<div class="div-progress-bar excellent"></div>
			<div class="div-progress-bar good"></div>
			<div class="div-progress-bar okay"></div>
			<div class="div-progress-bar poor"></div>
			<div class="div-progress-bar fail"></div>
			<ul class="ul-question-scores">
				<li border-left="black" border-width="3px" class="excellent li-question-score">1</li>
				<li class="good li-question-score">2</li>
				<li class="li-question-score okay">3</li>
				<li class="li-question-score poor">4</li>
		...
		<div class="div-revision-progress">
			<div class="text-revision-progress">20/40 : 50%</div>
		</div>
	</div>
	<div class="div-revision-tutorial-alert right">
		<h5 class="text-tutorial">NEXT QUESTION [shift + enter]</h5>
		<img class="img-tutorial-arrow right" src="<?=base_url('images/direction-tab-right.png')?>">
	</div>
</div>
<div class="div-generic-popup-wrapper">
		...
		<div class="w-tab-content">
			<div class="w--tab-active w-tab-pane" data-w-tab="question-tab">
				<div class="div-qna-wrapper">
					<div class="div-question-wrapper" data-ix="resource-toolbar-appear">
						...
						<div class="form-block-question w-form">
							<form class="div-qna-form question" data-name="Email Form" id="email-form" name="email-form">
								<textarea class="question text-area-qna w-input" data-name="Question Text 10" id="question-text-10" maxlength="5000" name="question-text-10" placeholder="Enter question..."></textarea>
							</form>
					...
					<div class="div-answer-wrapper ready-answer">
						<div class="answer div-qna-toolbar w-clearfix">
							<img class="img-qna-tool" id="add-bullet-point" src="<?=base_url('images/bullet-points-small.png')?>" width="20">
							<img class="img-qna-tool" id="add-image" src="<?=base_url('images/image-small.png')?>" width="20"><img class="img-qna-tool" id="delete-question" src="<?=base_url('images/delete-black.png')?>" width="20">
						</div>
						<div class="div-qna-header ready-answer" data-ix="answer-text-area-expand">
							<div class="div-qna-title">
								<h5 class="h-qna-title">#. Answer</h5>
							</div>
						</div>
						<div class="form-block-answer w-form">
							<form class="answer div-qna-form" data-name="Email Form" id="email-form" name="email-form"><textarea class="answer text-area-qna w-input" data-name="Answer Text 3" id="answer-text-3" maxlength="5000" name="answer-text-3" placeholder="Enter answer..."></textarea></form>
							<!--<div class="w-form-done">
								<div>Thank you! Your submission has been received!</div>
							</div>
							<div class="w-form-fail">
				...
				<div class="div-qna-wrapper">
					<div class="div-question-wrapper" data-ix="resource-toolbar-appear">
						<div class="div-qna-header">
							...
							<div class="div-qna-toolbar question w-clearfix"><img class="img-qna-tool" id="add-bullet-point" src="<?=base_url('images/bullet-points-small.png')?>" width="20"><img class="img-qna-tool" id="add-image" src="<?=base_url('images/image-small.png')?>" width="20"><img class="img-qna-tool" id="delete-question" src="<?=base_url('images/delete-black.png')?>" width="20"><img class="img-qna-tool" id="add-sub-question" src="<?=base_url('images/plus-s.png')?>" width="20"></div>
						</div>
						<div class="form-block-question w-form">
					...
					<div class="div-answer-wrapper">
						<div class="answer div-qna-toolbar w-clearfix"><img class="img-qna-tool" id="add-bullet-point" src="<?=base_url('images/bullet-points-small.png')?>" width="20"><img class="img-qna-tool" id="add-image" src="<?=base_url('images/image-small.png')?>" width="20"><img class="img-qna-tool" id="delete-question" src="<?=base_url('images/delete-black.png')?>" width="20"></div>
			...
			<div class="w-tab-pane" data-w-tab="comment-tab">
				<div class="comment form-block-question w-form">
					<form class="div-qna-form" data-name="Email Form" id="wf-form-Email-Form" name="wf-form-Email-Form"><textarea class="question text-area-qna w-input" data-name="Question Text 3" id="question-text-3" maxlength="5000" name="question-text-3" placeholder="Enter comment..."></textarea></form>
					<div class="w-form-done">
						<div>Thank you! Your submission has been received!</div>
					</div>
					<div class="w-form-fail">
				...
				<div class="div-questioln-comment-wrapper">
					<div class="div-qna-header">
						...
						<div class="div-qna-toolbar question w-clearfix"><img class="img-qna-tool" src="<?=base_url('images/edit-black.png')?>"><img class="img-qna-tool" id="delete-question" src="<?=base_url('images/delete-black.png')?>" width="20"></div>
	...
	<div class="div-user-settings">
		<h3 class="h-resource-main">User Settings</h3>
		<div class="form-block-name-resource w-form">
	...
	<div class="div-name-resource">
		<h3 class="h-resource-main">Add Course</h3>
		<div class="div-resource-parent">
			<h4 class="h-resource-parent">University of Manchester</h4>
		</div>
		<div class="form-block-name-resource w-form">
			<form class="form-name-resource w-clearfix" data-name="Email Form" id="email-form" name="email-form">
	...
	<div class="div-add-resource">
		<h3 class="h-resource-main">Add Course</h3>
		<div class="div-resource-parent">
			<img class="backward img-toggle-resource-parent-history" src="<?=base_url('images/toggle-left-arrow-black.png')?>">
			<h4 class="h-resource-parent">Schools</h4>
			<img class="forward img-toggle-resource-parent-history" src="<?=base_url('images/toggle-right-arrow-black.png')?>">
		</div>
		<ul class="ul-resource-parent">
			<li class="li-resource-parent">University of Manchester</li>
			<li class="li-resource-parent">Woodkirk High School</li>
			<li class="li-resource-parent">Word of Faith Group of Schools</li>
			<li class="li-resource-parent">Brighter Primary School</li>
		</ul>
	</div>
</div>
