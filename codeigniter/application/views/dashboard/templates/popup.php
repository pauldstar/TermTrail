          ...
          <div class="div-qna-wrapper">
            <div class="div-question-wrapper" data-ix="resource-toolbar-appear">
              <div class="div-qna-header">
                ...
                <div class="div-qna-toolbar icon-wrapper question w-clearfix"><img class="img-qna-tool" id="add-bullet-point" src="<?=base_url('images/bullet-points-small.png')?>" width="20"><img class="img-qna-tool" id="add-image" src="<?=base_url('images/image-small.png')?>" width="20"><img class="img-qna-tool" id="delete-question" src="<?=base_url('images/delete-black.png')?>" width="20"><img class="img-qna-tool" id="add-sub-question" src="<?=base_url('images/plus-s.png')?>" width="20"></div>
              </div>
            ...
            <div class="div-answer-wrapper ready-answer">
              <div class="answer div-qna-toolbar icon-wrapper w-clearfix"><img class="img-qna-tool" id="add-bullet-point" src="<?=base_url('images/bullet-points-small.png')?>" width="20"><img class="img-qna-tool" id="add-image" src="<?=base_url('images/image-small.png')?>" width="20"><img class="img-qna-tool" id="delete-question" src="<?=base_url('images/delete-black.png')?>" width="20"></div>
